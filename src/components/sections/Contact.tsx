...
const CONTACT_INFO = [
  { icon: MapPin, label: 'Address', value: 'Derb el Hammam, Medina, Marrakech 40000, Morocco' },
  { icon: Phone, label: 'Phone', value: '+212 524 123 456', href: 'tel:+212524123456' },
  { icon: Mail, label: 'Email', value: 'info@riadmarrakech.com', href: 'mailto:info@riadmarrakech.com' },
];
...
export function Contact() {
  ...
  return (
    <section id="contact" className="py-16 md:py-24 px-4 bg-[#F5F0E8] overflow-hidden">
              ...
              <div>
                ...
                <ul className="space-y-5">
                  {CONTACT_INFO.map(({ icon: Icon, label, value, href }, i) => (
                    <Reveal key={label} direction="left" delay={i * 0.1}>
                      <li className="flex items-start gap-4">
                        ...
                        <div>
                          ...
                          {href ? (
                            <a href={href} className="text-foreground/80 hover:text-[#7C8A5D] transition-colors text-sm">{value}</a>
                          ) : (
            ...
            <Reveal direction="left" delay={0.3}>
              <div className="bg-[#3D4A2B] rounded-2xl p-6 text-white">
                ...
                <ul className="space-y-2 text-white/80 text-sm">
                  {[['Front Desk', '24 / 7'], ['Breakfast', '07:00 – 10:30'], ['Lunch', '12:00 – 14:30'], ['Dinner', '19:00 – 22:00'], ['Spa & Hammam', '09:00 – 21:00']].map(([label, time]) => (

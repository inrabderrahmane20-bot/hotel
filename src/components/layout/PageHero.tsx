...
export function PageHero({ title, subtitle, image, breadcrumb }: Props) {
  return (
    <div className="relative h-56 sm:h-64 md:h-80 mt-16 flex items-center justify-center overflow-hidden">
      <ImageWithFallback src={image} alt={title} className="absolute inset-0 w-full h-full object-cover" />
      ...
      <div className="relative z-10 text-center text-white px-4 max-w-3xl mx-auto">
        {breadcrumb && (
          <motion.div
            ...
            className="flex items-center justify-center gap-1.5 text-white/60 text-sm mb-3"
          >
        ...
        {subtitle && (
          <motion.p
            ...
            className="text-white/80 text-sm sm:text-base max-w-xl mx-auto"
          >
            {subtitle}
          </motion.p>
        )}
